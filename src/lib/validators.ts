...
export const ToolAuditResultSchema = z.object({
  ...
  currentMonthlyCostINR: z.number(),
  recommendedPlan: z.string().optional(),
  recommendedMonthlyCost: z.number().optional(),
  recommendedMonthlyCostINR: z.number().optional(),
  monthlySavings: z.number(),
  monthlySavingsINR: z.number(),
...
export const AuditResultSchema = z.object({
  ...
  totalCurrentMonthlySpendINR: z.number(),
  totalOptimizedMonthlySpend: z.number(),
  totalOptimizedMonthlySpendINR: z.number(),
  totalMonthlySavings: z.number(),
  totalMonthlySavingsINR: z.number(),
